...
namespace TailInstallationSystem
{
    ...
    public class TighteningAxisData
    {
        ...
        /// 运行状态代码 (地址5100)
        /// </summary>
        public int RunningStatusCode { get; set; }
        ...
        public static TighteningAxisData CreateTestData(bool isQualified = true)
        {
            return new TighteningAxisData
            {
                ...
                RunningStatusCode = isQualified ? 10 : 21,
                Status = isQualified ? TighteningStatus.Qualified : TighteningStatus.TorqueTooLow,
                ErrorCode = 0,
                CompletedTorque = isQualified ? 2.1f : 1.5f,
                RealtimeTorque = 0f,
                TargetTorque = 2.0f,
                LowerLimitTorque = 1.8f,
                UpperLimitTorque = 2.2f,
